...
#include "boat_2920769f_49_ds_obs_il.h"
#include "boat_2920769f_49_ds.h"
#include "boat_2920769f_49_ds_externals.h"
#include "boat_2920769f_49_ds_external_struct.h"
#include "ssc_ml_fun.h"
int32_T boat_2920769f_49_ds_obs_il ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * out ) { static boolean_T
_cg_const_1 [ 36 ] = { true , true , true , true , true , true , true , true
, true , true , false , true , true , false , false , true , false , true ,
true , true , true , true , true , true , true , true , true , true , true ,
true , false , false , true , false , false , false } ; ( void ) t1 ; out ->
