...
#endif
#include "nesl_rtw.h"
#include "boat_2920769f_49.h"
#include "boat_2920769f_1_gateway.h"
void boat_2920769f_1_gateway ( void ) { NeModelParameters modelparams = { ( enum
NeSolverTypeTag ) 0 , 0.001 , 0.001 , 0.001 , TRUE , FALSE , ( enum
NeModifyAbsTolTag ) 2 , 0.001 , 0.0 , FALSE , FALSE , FALSE , ( enum
SscLoggingSettingTag ) 3 , 652223420.0 , FALSE , FALSE , FALSE } ;
...
sizeof ( outputparameters_init [ 0 ] ) ; } boat_2920769f_49_dae ( & dae , &
modelparams , & solverparams ) ; nesl_register_simulator_group ( "boat/Solver Configuration1_1" , 1 , & dae , & solverparams , & modelparams , numOutputs , outputparameters , 0 , rtpDaes , 1 , rtwLogDaes , 0 , solverHitDaes ) ; }
