...
void boat_57910a22_1_gateway ( void ) { NeModelParameters modelparams = { ( enum
...
sizeof ( outputparameters_init [ 0 ] ) ; } boat_57910a22_49_dae ( & dae , &
modelparams , & solverparams ) ; nesl_register_simulator_group ( "boat/Solver Configuration_1" , 1 , & dae , & solverparams , & modelparams , numOutputs , outputparameters , 0 , rtpDaes , 1 , rtwLogDaes , 0 , solverHitDaes ) ; }
